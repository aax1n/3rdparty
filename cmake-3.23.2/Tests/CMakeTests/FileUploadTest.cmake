file(REMOVE_RECURSE "/home/xin/tools/cmake-3.23.2/Tests/CMakeTests/uploads")

if(EXISTS "/home/xin/tools/cmake-3.23.2/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/home/xin/tools/cmake-3.23.2/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/home/xin/tools/cmake-3.23.2/Tests/CMakeTests/uploads")

set(filename "/home/xin/tools/cmake-3.23.2/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/home/xin/tools/cmake-3.23.2/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/home/xin/tools/cmake-3.23.2/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/xin/tools/cmake-3.23.2/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/xin/tools/cmake-3.23.2/Tests/CMakeTests/uploads/file2.png"
